import UserP from './dist/img/kianna.jpg';
    ...
    <div id='searchWrap'>
        <Row>
            <Col md='12'>
              <Form>
                <input 
                  className="form-control suche shadow-sm" 
                  type="text" 
                  placeholder="Search Expedo" 
                  aria-label="Search" 
                  />
                <Button className='btn-search'>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </Button>
                <div className='suche-btn-wrap'>
                  <div className='icon-wrap'>
                    <a href='#!' className='search-icons'>
                  ...
                  <a href='#!'>
                    <img src={UserP} className='userp' alt='user' />
                  </a>
                  <a href='#!'>
                    <span className='user-name'>Kianna Moore</span>
                  </a>
                  <span className='user-t'>XYZ Company</span>
                  <a href="#!" className='chev-d'>
